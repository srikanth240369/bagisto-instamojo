...
namespace Srikanth\Instamojo\Payment;
 ...
 */
class Standard extends Instamojo
{
    /**
     * Payment method code
     *
     * @var string
     */
    protected $code  = 'instamojo_standard';
    ...
    {
        return route('instamojo.standard.redirect');
    }
    ...
    public function getFormFields()
    {
        ...
        $fields = [
            ...
            'paymentaction'   => 'sale',
            'return'          => route('instamojo.standard.success'),
            'cancel_return'   => route('instamojo.standard.cancel'),
            'notify_url'      => route('instamojo.standard.ipn'),
            'charset'         => 'utf-8',
